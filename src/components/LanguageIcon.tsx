...
export const LanguageIcon: React.FC<LanguageIconProps> = ({ isHovered: _isHovered }) => {
  return (
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-5 h-5">
      ...
      <g className="transition-all duration-500 ease-out opacity-80 group-hover:opacity-0">
        {/* Left stroke of A */}
        <line x1="6" y1="18" x2="12" y2="6" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
        {/* Right stroke of A */}
        <line x1="18" y1="18" x2="12" y2="6" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
        {/* Middle bar of A */}
      ...
      <g className="transition-all duration-500 ease-out opacity-0 group-hover:opacity-80">
        ...
        <path d="M12 10 Q9 13 6 18" stroke="currentColor" strokeWidth="2" strokeLinecap="round" fill="none" />
        {/* Right diagonal sweep (捺) */}
        <path d="M12 10 Q15 13 18 18" stroke="currentColor" strokeWidth="2" strokeLinecap="round" fill="none" />
      </g>
    </svg>
  );
};
