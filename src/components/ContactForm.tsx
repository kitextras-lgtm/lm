            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={handleChange}
                  className="h-11 w-full px-4 bg-transparent border border-neutral-700 text-white rounded-lg focus:border-neutral-500 focus:outline-none cursor-pointer"
                >
                  <option value="" className="bg-neutral-900 text-white">Select a topic</option>
                  ...
                  <option value="support" className="bg-neutral-900 text-white">Support</option>
