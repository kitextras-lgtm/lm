  ...
  return (
    <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className="overflow-visible">
      ...
      <path
        ...
        fill="none"
      />
      <circle cx="38" cy="12" r="1.5" fill="currentColor" className="opacity-0 group-hover:opacity-80 transition-opacity duration-300" />
      <circle cx="10" cy="14" r="1" fill="currentColor" className="opacity-0 group-hover:opacity-60 transition-opacity duration-300 delay-100" />
    </svg>
  );
}
...
export function AdminSettingsIconSVG({ }: { isHovered?: boolean; isActive?: boolean }) {
  return (
    <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className="overflow-visible">
      ...
      <circle cx="24" cy="24" r="3" fill="currentColor" className="opacity-0 group-hover:opacity-60 transition-opacity duration-300" />
    </svg>
  );
}
  ...
  return (
    <div className="relative w-7 h-7">
      <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-7 h-7 overflow-visible">
        <rect x="12" y="8" width="24" height="32" rx="3" stroke="currentColor" strokeWidth="3.5" fill="none" />
      <path
        ...
        fill="none"
      />
      <line x1="17" y1="16" x2="31" y2="16" stroke="currentColor" strokeWidth="3.5" strokeLinecap="round" className="opacity-50" />
      <line x1="17" y1="22" x2="28" y2="22" stroke="currentColor" strokeWidth="3.5" strokeLinecap="round" className="opacity-50" />
      <path
      ...
      />
      <circle cx="36" cy="12" r="2" fill="currentColor" className={`transition-all duration-300 delay-200 ${shouldAnimate ? 'opacity-100 scale-100' : 'opacity-0 scale-0'}`} />
      <circle cx="40" cy="18" r="1.5" fill="currentColor" className={`transition-all duration-300 delay-300 ${shouldAnimate ? 'opacity-70 scale-100' : 'opacity-0 scale-0'}`} />
      <circle cx="38" cy="24" r="1" fill="currentColor" className={`transition-all duration-300 delay-400 ${shouldAnimate ? 'opacity-50 scale-100' : 'opacity-0 scale-0'}`} />
    </svg>
    </div>
  );
}
  ...
  return (
    <div className="relative w-7 h-7">
      ...
      <g className="transition-all duration-400 ease-out origin-center" style={{ transform: shouldAnimate ? 'translateX(8px) translateY(-4px) rotate(6deg)' : 'translate(0, 0) rotate(0deg)' }}>
        <path d="M8 24L40 12L32 36L24 28L8 24Z" stroke="currentColor" strokeWidth="3.5" strokeLinejoin="round" fill="none" />
        <path d="M8 24L40 12L24 28" stroke="currentColor" strokeWidth="3.5" strokeLinejoin="round" />
        <path d="M24 28L32 36" stroke="currentColor" strokeWidth="3.5" strokeLinecap="round" />
      </g>
      <g className={`transition-all duration-300 ${shouldAnimate ? 'opacity-100' : 'opacity-0'}`}>
        <path d="M4 22L10 24" stroke="currentColor" strokeWidth="3.5" strokeLinecap="round" className="opacity-70" />
        <path d="M6 28L12 26" stroke="currentColor" strokeWidth="3.5" strokeLinecap="round" className="opacity-50" />
        <path d="M2 25L8 25" stroke="currentColor" strokeWidth="3.5" strokeLinecap="round" className="opacity-30" />
      </g>
      <g className={`transition-all duration-300 delay-150 ${shouldAnimate ? 'opacity-100' : 'opacity-0'}`}>
        ...
        <path d="M44 8L46 6" stroke="currentColor" strokeWidth="3.5" strokeLinecap="round" />
        <path d="M44 12L46 14" stroke="currentColor" strokeWidth="3.5" strokeLinecap="round" />
      </g>
    </svg>
    </div>
  );
  ...
  return (
    <div className={`relative w-7 h-7`}>
      <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-7 h-7 overflow-visible">
        {/* Main chat bubble */}
        <path
          d="M36 8H12C8.68629 8 6 10.6863 6 14V30C6 33.3137 8.68629 36 12 36H16L24 44L32 36H36C39.3137 36 42 33.3137 42 30V14C42 10.6863 39.3137 8 36 8Z"
          stroke="currentColor"
          strokeWidth="3.5"
          strokeLinejoin="round"
          fill="none"
        ...
        />
        {/* Three dots - always visible and clear */}
  ...
  return (
    <div className="relative w-7 h-7">
      ...
      <g className="transition-transform duration-300" style={{ transform: shouldAnimate ? 'scale(0.95)' : 'scale(1)' }}>
        <circle cx="12" cy="28" r="4" stroke="currentColor" strokeWidth="3.5" fill="none" className="opacity-50" />
        <path d="M6 42C6 38 8 36 12 36C16 36 18 38 18 42" stroke="currentColor" strokeWidth="3.5" strokeLinecap="round" className="opacity-50" />
        <circle cx="24" cy="26" r="5" stroke="currentColor" strokeWidth="3.5" fill="none" className="opacity-70" />
        <path d="M16 42C16 37 19 34 24 34C29 34 32 37 32 42" stroke="currentColor" strokeWidth="3.5" strokeLinecap="round" className="opacity-70" />
        <circle cx="36" cy="28" r="4" stroke="currentColor" strokeWidth="3.5" fill="none" className="opacity-50" />
      ...
      <circle cx="24" cy="26" r="7" stroke="currentColor" strokeWidth="3.5" fill="none" className={`transition-opacity duration-300 ${shouldAnimate ? 'opacity-50' : 'opacity-0'}`} strokeDasharray="4 2" />
    </svg>
    </div>
  );
}
...
export function AdminDataIconSVG({ isHovered, isActive }: { isHovered?: boolean; isActive?: boolean }) {
  ...
  return (
    <div className="relative w-7 h-7">
      <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-7 h-7 overflow-visible">
      <ellipse cx="24" cy="36" rx="12" ry="4" stroke="currentColor" strokeWidth="3.5" fill="none" />
      <path d="M12 36V32C12 30.34 17.37 29 24 29C30.63 29 36 30.34 36 32V36" stroke="currentColor" strokeWidth="3.5" className="transition-transform duration-300" />
      <ellipse cx="24" cy="28" rx="12" ry="4" stroke="currentColor" strokeWidth="3.5" fill="none" className="transition-transform duration-300" style={{ transform: shouldAnimate ? 'translateY(-4px)' : 'translateY(0)' }} />
      <path d="M12 28V24C12 22.34 17.37 21 24 21C30.63 21 36 22.34 36 24V28" stroke="currentColor" strokeWidth="3.5" className="transition-transform duration-300" style={{ transform: shouldAnimate ? 'translateY(-4px)' : 'translateY(0)' }} />
      <ellipse cx="24" cy="20" rx="12" ry="4" stroke="currentColor" strokeWidth="3.5" fill="none" className="transition-transform duration-300" style={{ transform: shouldAnimate ? 'translateY(-8px)' : 'translateY(0)' }} />
      <circle cx="38" cy="22" r="1.5" fill="currentColor" className={`transition-opacity duration-300 animate-pulse ${shouldAnimate ? 'opacity-80' : 'opacity-0'}`} />
      <circle cx="10" cy="28" r="1" fill="currentColor" className={`transition-opacity duration-300 delay-100 animate-pulse ${shouldAnimate ? 'opacity-60' : 'opacity-0'}`} />
    </svg>
    </div>
  );
}
